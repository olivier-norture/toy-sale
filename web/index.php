    ...
    <div id="main_content"> <!-- main_content -->
            ...
            <div id="contact_area"> <!-- #contact_area -->
                ...
                <div class="container"> <!-- .container -->
                    ...
                    <br />
                    <br />
                    <label>L'adresse IP de ce PC est : " <b><?php echo array_key_exists('HTTP_X_FORWARDED_FOR', $_SERVER) ? explode(',', $_SERVER['HTTP_X_FORWARDED_FOR'])[0] : $_SERVER['REMOTE_ADDR']; ?></b> "</label>
                    <br />
                    <br />
                    <br />
