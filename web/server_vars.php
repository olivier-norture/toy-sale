                    ...
                    <div id="server-vars-list">                    
                            <fieldset> 
                                <table> <!-- Tableau des jouets à ajouter 10 max -->
                                    ...
                                    <!-- add a new pc -->
                                    <tr>
                                        <form action="#" method="post" id="createServerVar">
